...
class CustomListCompleteTest {
    ...
    @Test
    void test_removeById_returnsObjectWhenSucceeds() {
        CustomList<String> testList = new CustomList<>();
        testList.add("test1");
        testList.add("test2");
        testList.add("test3");
    ...
    @Test
    void test_removeById_returnsNullWhenNoObjectFound() {
        CustomList<String> testList = new CustomList<>();
    ...
    @Test
    void test_argsConstructor_returnsPopulatedArray() {
        CustomList<String> testList = new CustomList<>(new String[]{"testList"});
        assertEquals(1, testList.size());
    }

    @Test
    void test_toArray_returnsExpectedArray() {
        String[] testArray = new String[] {"TestItem1", "TestItem2"};
        CustomList<String> testList = new CustomList<>(testArray);
